...
BEGIN
 ...
 WHERE "version" = 101 AND "dirty" IS FALSE;
...
INSERT INTO "user" ("id", "external_id", "name", "properties", "email", "password_hash") VALUES
('00000000-0000-0000-0001-000000000001',	'1',	'Developer',	'{}',	'developer@example.com',	'$argon2id$v=19$m=65536,t=3,p=4$O4Cv1vR+f8u+yhkSfsSRKQ$P2xKik9SFuhQKGrzDnfrQYloO3bfJ3hjr5V00d4kauA'),
('00000000-0000-0000-0001-000000000002',	'2',	'Developer 2',	'{}',	'developer2@example.com',	'$argon2id$v=19$m=65536,t=3,p=4$O4Cv1vR+f8u+yhkSfsSRKQ$P2xKik9SFuhQKGrzDnfrQYloO3bfJ3hjr5V00d4kauA'),
('00ACCE55-0400-A110-1337-000000000000',	'PBLC',	'Everyone',	'{}',	NULL,	NULL);
